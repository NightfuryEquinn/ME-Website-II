    ...
    <>
      <div className="flex justify-end">
        <Animator active duration={{ enter: 1.0, exit: 1.0, delay: 0.5 }}>
          <button onMouseEnter={ bleepOnHover } onClick={ bleepOnExit } className="relative px-6 py-2 mb-10 max-w-40 w-full animate-fade animate-delay-300">
            <FrameCorners className="exit-frame" />
            <div className="relative -z-10 flex flex-row gap-2 justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="text-light-pink">

  ...
  return <>
    <Animator>
      <div className="relative">
        <FrameCorners className="accordian-frame" />
        <button onMouseEnter={ bleepOnHover } onClick={ onToggle } className="w-full">
          <div className="px-4 py-3 flex flex-row justify-between items-center animate-fade animate-delay-[2000ms]">
            <Text
              as="p"
              manager="sequence"
            ...
            {
              isOpen ?
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" className="relative z-10">
...

        {
          isOpen && 
            <>
              <hr className="border-dark-purple mx-10 my-2 border-1 animate-fade animate-delay-700" />

              <div className="p-4 flex flex-row gap-4 items-center relative z-10">
                <Animator>
                  <div className="animate-fade animate-delay-700">
                    {
                      ...
                      :
                        <Text
                          as="p"
                          manager="sequence"
                          className="text-sm text-left text-white tracking-widest"
                          fixed
                        >
                          Not Available
                        </Text>
